...
class ForgotPasswordController extends AdminController
{
    ...
    public function postForgotPassword(Request $request)
    {
        ...
        $link = route('admin.auth.users.getVerifyForgotPassword')."?email=".$email."&token=".$token;
        ...
        session()->flash('verify-forgot-password', 'Vui lòng kiểm tra hộp thư để xác thực việc đổi mật khẩu.');
